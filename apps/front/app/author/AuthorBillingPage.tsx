...
export function AuthorBillingPage() {
        ...
        <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="space-y-4">
            ...
            >
              ...
              <option value="subscription">ต่ออายุสมาชิก</option>
            </select>
            ...
            {mode === "topup" ? (
              ...
              <div className="space-y-4">
                <div className="text-base font-medium">ต่ออายุสมาชิก</div>
                <input
                  value="1999 บาท"
                  readOnly
                  className="w-full rounded-lg border border-gray-300 bg-gray-50 px-3 py-2 text-sm"
                ...
                <button
                  ...
                  className="w-full rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white disabled:opacity-60"
                >
                  {submitting === "subscription" ? "กำลังบันทึก..." : "ต่ออายุสมาชิก"}
                </button>
              </div>
            )}
          </div>
