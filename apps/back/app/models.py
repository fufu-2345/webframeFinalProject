...
class eBook(models.Model):
    ...
    author = models.ForeignKey(SystemUser, on_delete=models.CASCADE, limit_choices_to={'role': 'author'})
    ...
    poststatus = models.CharField(max_length=20, choices=STATUS_CHOICES, default='Unpublish')
